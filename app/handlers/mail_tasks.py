...
schedule_email_update_handler = MessageHandler(schedule_email_update, filters.command("schedule_email_update") & filters.private)
...
remove_scheduled_email_update_handler = MessageHandler(remove_scheduled_email_update, filters.command("remove_scheduled_email_update") & filters.private)
